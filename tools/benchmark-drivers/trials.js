...
exports.default = [
        ...
        description: 'reading rows individually' },
    {
        ...
        description: 'reading large blobs'
    },
        ...
        description: 'inserting rows individually' },
    {
        ...
        description: 'inserting large blobs'
    },
    {
        type: 'update', table: 'small', columns: ['nul', 'integer', 'real', 'text'],
        description: 'updating rows individually'
    },
    {
        type: 'update', table: 'large_blob', columns: ['blob'],
        description: 'updating large blobs'
    },
...
exports.searchable = [
    ...
    { type: 'update', table: 'small', columns: ['nul'] },
    { type: 'update', table: 'small', columns: ['integer'] },
    { type: 'update', table: 'small', columns: ['real'] },
    { type: 'update', table: 'small', columns: ['text'] },
    { type: 'update', table: 'small', columns: ['blob'] },
    { type: 'update', table: 'large_text', columns: ['text'] },
    { type: 'update', table: 'large_blob', columns: ['blob'] },
    { type: 'update-transaction', table: 'small', columns: ['nul'] },
    { type: 'update-transaction', table: 'small', columns: ['integer'] },
    { type: 'update-transaction', table: 'small', columns: ['real'] },
    { type: 'update-transaction', table: 'small', columns: ['text'] },
