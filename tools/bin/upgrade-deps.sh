#!/usr/bin/env bash
#
# upgrade-deps.sh — Check for SQLite bumps and dependency upgrades, then apply them
#
# Usage: upgrade-deps.sh [OPTIONS]
#
# Options:
...
readonly UPGRADE_SQLITE_SCRIPT="${PROJECT_ROOT}/tools/bin/upgrade-sqlite.sh"
